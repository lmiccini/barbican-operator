...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/test v0.6.1-0.20260810100427-d0249ca0cf26
...
replace github.com/openstack-k8s-operators/barbican-operator/api => ./api
...
replace github.com/openstack-k8s-operators/lib-common/modules/common => github.com/lmiccini/lib-common/modules/common v0.0.0-20260813132232-f48a09125649
